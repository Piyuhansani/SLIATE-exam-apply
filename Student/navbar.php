    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-warning fixed-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <img src="../Images/images.png" alt="Logo" style="width: 150px;">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="already_applied.php">Home</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="d-flex align-items-center">
                    <img src="../Images/profile-user.png" class="rounded-circle" style="width: 40px; cursor: pointer;" data-bs-toggle="dropdown" alt="User">
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="edit_profile.php"><img src="../Images/user-avatar.png" class="me-2" style="width: 20px;">Edit Profile</a></li>
                        ...
                        <li><a class="dropdown-item" href="login.php"><img src="../Images/logout.png" class="me-2" style="width: 20px;">Log Out</a></li>
                    </ul>
                </div>
            </div>
        </div>
